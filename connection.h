...
typedef void (*new_conn_cb)(int fd);
typedef void (*read_cb)(connection* conn, uint8_t *data, uint32_t len);
typedef void (*write_cb)(connection* conn);
typedef void (*close_cb)(connection* conn);
